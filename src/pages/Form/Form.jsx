                ...
                <div id={index}  key={index} style={{border: lightMode ? "1px" : "0px", borderStyle: lightMode ? "solid" : "", borderColor: lightMode ? "#D6D6D6" : ""}} className={lightMode ? "formTagLight" : "formTag"}>
                    ...
                    <div  style={{display: tag.type === "input" ? "" : "none", color: "white"}} className="hint">
                        ...
                        <span style={{fontSize: "12px", color: "#555555"}} >
                            ...
                            {tag.name === "Buttons" ?<input id={`${index}`} value={tag.value || ""} onChange={handleChange} style={{backgroundColor: lightMode ? "white" : "#1F1F23",color: lightMode ? "" : "white",fontSize: "16px", borderRadius: "5px", border:"1px", borderStyle:"solid", borderColor:"#F55050",width:"100%", padding:"12px 0" }} type="text" placeholder="Enter Button Name" />: null}
                        </span>
