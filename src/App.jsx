...
{screeSize.width < 850 ? <div style={{color:"white", height:"100vh", display:"flex", justifyContent:"center", alignItems:"center", flexWrap:"nowrap"}}> This website is designed to work best on PCs and laptops for an enhanced experience. </div> :
