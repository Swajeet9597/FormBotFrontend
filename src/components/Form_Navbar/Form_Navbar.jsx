  ...
  return (
    <div style={{backgroundColor : lightMode ? "white" : null}} className={lightMode ? light[0] : "Form_Navbar"} >
      ...
      <div className="flowResponse">
            <div style={ decodedValue == "response" ?{ border: "none", cursor: "pointer",
                        color: lightMode ? "black" : "white",
                        borderRadius: "6px",
                        fontSize: "14px",
                        padding: "7px 10px"} : {border: "1px", 
                        borderStyle: "solid", 
                        borderColor: "#7EA6FF",
                        cursor: "pointer",
                        color: "#7EA6FF",
            ...
            <div onClick={handleResponse} style={ decodedValue !== "response" ?{ border: "none", cursor: "pointer",
                        color: lightMode ? "black" : "white",
                        borderRadius: "6px",
                        fontSize: "14px",
                        padding: "7px 10px"} : {border: "1px", 
